let timer = 0;
        ...
        window.onload = function () {
            ...
            document.getElementById('testoA-button').addEventListener('click', () => navigateToPage('testoA.html'));
            document.getElementById('testoB-button').addEventListener('click', () => navigateToPage('testoB.html'));
